...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus-square"></span>  Añadir nuevo</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='far fa-plus-square'></i> Añadir nueva categoría ","categories/manage_category.php")
		})
		$('.edit-data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Editar categoría ","categories/manage_category.php?id="+$(this).attr('data-id'))
		})
		$('.view-data').click(function(){
			uni_modal("<i class='fa fa-th-list'></i> Detalle de la categoría ","categories/view_category.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
