...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		<h3 class="card-title">Detalle de la canción</h3>
		<div class="card-tools">
			<a href="<?= base_url."admin/?page=musics/manage_music&id={$id}"?>" class="btn btn-flat btn-primary bg-primary"><span class="fas fa-edit"></span>  Editar</a>
			<button id="delete_data" type="button" class="btn btn-flat btn-danger bg-danger"><span class="fas fa-trash"></span>  Editar</button>
			<a href="<?= base_url."admin/?page=musics"?>" class="btn btn-flat btn-light bg-light"><span class="fas fa-angle-left"></span>  Volver a la lista</a>
		</div>
	</div>
	<div class="card-body">
        <div class="container-fluid">
			...
			<div class="form-group">
				<label for="" class="control-label">Archivo de audio</label>
				...
				<?php else: ?>
					<div class="pl-4"><span class="text-muted">No se agregó ningún archivo.</span></div>
				<?php endif; ?>
			</div>
			<div class="form-group">
