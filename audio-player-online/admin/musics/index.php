...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		<h3 class="card-title">Lista de Musicas</h3>
		<div class="card-tools">
			<a href="./?page=musics/manage_music" class="btn btn-flat btn-primary"><span class="fas fa-plus-square"></span>  Añadir nuevo</a>
		</div>
	</div>
	<div class="card-body">
							...
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item view-data" href="<?= base_url."admin/?page=musics/view_music&id={$row['id']}" ?>"><span class="fa fa-eye text-light"></span> Ver</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item edit-data" href="<?= base_url."admin/?page=musics/manage_music&id={$row['id']}" ?>"><span class="fa fa-edit text-primary"></span> Editar</a>
										<div class="dropdown-divider"></div>
