...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		<h3 class="card-title"><?= isset($id) ? "Actualizar detalles de la música" : "Agregar nueva música" ?></h3>
	...
	<div class="card-body">
        <div class="container-fluid">
			<form action="" id="music-form">
				...
				<div class="form-group">
					<label for="" class="control-label">banner de la música</label>
					...
					<label class="custom-file-label" for="customFile2">Subir archivo</label>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="" class="control-label">Archivo de música</label>
	...
	<div class="card-footer py-2 text-center">
		<button class="btn btn-primary rounded-0" type="submit" form="music-form">Guardar</button>
	</div>
</div>
<script>
