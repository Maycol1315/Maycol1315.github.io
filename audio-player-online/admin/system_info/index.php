		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Nombre la página web</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Nombre - panel admin</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo de la página web</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile1" name="img" onchange="displayImg(this,$(this))">
	              <label class="custom-file-label" for="customFile1">Buscar archivo</label>
	            </div>
			</div>
			...
			<div class="form-group">
				<label for="" class="control-label">Fondo de la página - admin</label>
				<div class="custom-file">
