...
<div class="row">
    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 mx-auto mt-5 mb-3 ">
        <h1 class="text-center font-weight-bolder title-font text-white"><?= $page_title ?></h1>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto mb-5">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3 cat-items">
                <div class="card rounded-0 card-outline card-primary h-100" style="background-color: #121212;">
                    <div class="card-img-top music-banner" style="background-color: #121212;">
                        <img src="<?= validate_image($row['banner_path']) ?>" alt="<?= $row['title'] ?>">
                    </div>
                    <div class="card-body rounded-0">
                        <div class="container-fluid">
                            <div>
                                <h3 class="rounded-0 card-title-font text-center w-100 text-white"><b><?= $row['title'] ?></b></h3>
                            </div>
                            <div class="">
...
<div id="player-field">
    ...
    <div id="player-slider">
        <div id="music-title" class="text-light"><span id="title">Título de la canción</span> - <span class="mx-4 text-muted" id="artist">Test</span></div>
...
<script>
    ...
    $(function(){
        ...
        $('.view_music_details').click(function(e){
            ...
            uni_modal("Detalle de la canción", "<?= base_url."view_music_details.php?id=" ?>"+id,"modal-large")
        })
